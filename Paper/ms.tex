...
Figure~\ref{fig:fake_data}, along with a model fit.
...
322 ms$^{-1}$ and 214 ms$^{-1}$ respectively. There are also three
...
\caption{\label{fig:fake_data_N}}
\end{figure}

\begin{figure}
\includegraphics[scale=0.4]{Figures/fake_data_periods.eps}
\caption{\label{fig:fake_data_periods}}
\end{figure}
