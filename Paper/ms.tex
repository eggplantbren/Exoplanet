...
to the marginal likelihood of $-640.1$ found by \citet{fengji}, although it
is unclear whether we used exactly the same dataset.

\section{Conclusions}
In this letter we introduced a trans-dimensional MCMC approach to inferring
...
is 70\%. With the combined HIRES+HARPS dataset from Gliese 581, we found
...
any such periodic signals will be attributed to planets. Including non-planetary
stellar variability is a crucial next step.
