...
The traditional approach also contradicts standard practice in Bayesian
computation. Imagine we are trying to compute the posterior distribution for
a parameter $a$ in the presence of a nuisance parameter $b$. This is solved
...
Yet when the hypothesis space for $a$ is already discrete, the wasteful
alternative somehow becomes standard practice.
