...
given the hyperparameter $\mu_A$. Our prior for $\mu_A$ spans many orders of
...
in the dataset, which is not strictly a valid strategy. The 
Truncation intervals are specified with the $T(a,b)$ notation.\label{tab:priors}}
\end{table*}
